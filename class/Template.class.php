		...
		'
						<div class="template-main template-clear-fix">
							...
							<div class="template-header-top-logo">
								<a href="'.self::getPageURL('home-1',false).'">
			...
			'
								<nav class="template-component-menu-default">
									<ul class="sf-menu template-clear-fix">
										...
										'.self::createMenuItem('home-1','Exit One Page','stroller').'
									</ul>
								</nav>
									...
									<ul class="template-clear-fix">
										<li>
											...
											<ul>
												...
												'.self::createMenuItem('home-1','Exit One Page').'
											</ul>
										</li>
									</ul>
								</nav>
								...
								<nav class="template-component-menu-default">
									...
									<ul class="sf-menu template-clear-fix">
										...
										<li class="sf-mega-enable-0">
											'.self::createMenuItem('#','Home','home',false).'
											<ul>
												'.self::createMenuItem('home-1','Home Style I').'
												'.self::createMenuItem('home-2','Home Style II').'
												'.self::createMenuItem('home-3','Home Style III').'
												'.self::createMenuItem('home-4','Home Style IV').'
												'.self::createMenuItem('home-5','Home Style V').'
											</ul>
										</li>
								...
								<nav class="template-component-menu-responsive">
									...
									<ul class="template-clear-fix">
										...
										<li>
											...
											<ul>
												<li>
													'.self::createMenuItem('#','Home',true,false).'
													<ul>
														'.self::createMenuItem('home-1','Home Style I').'
														'.self::createMenuItem('home-2','Home Style II').'
														'.self::createMenuItem('home-3','Home Style III').'
