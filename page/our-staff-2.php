					...
					<ul class="template-layout-100 template-clear-fix">
							...
							<ul class="template-layout-33x66 template-clear-fix">
								<li class="template-layout-column-left">
									<div class="template-component-image template-component-image-hover-slide-enable template-fancybox template-preloader">
										<a href="media/image/_sample/525x560/13.jpg" data-fancybox-group="team-1">
								...
								<li class="template-layout-column-right">
									<h3 class="template-component-team-name">Anna Smith</h3>
									<span class="template-component-team-position">Teacher</span>
									<p class="template-component-team-description">I hold a degree in Early Childhood Education and an advanced English language certificate. I have been working as a kindergarten teacher since 2002. I love working with children and getting to know their personalities and having fun with them. I look forward to meeting you and your children in the near future.</p>
									...
									<div class="template-component-vertical-grid">
										<ul>
											<li class="template-component-vertical-grid-line-1n">
												<div>Degree:</div>
												<div>Early Childhood Education</div>
											</li>
						...
						<li class="template-layout-column-left">
							<ul class="template-layout-33x66 template-clear-fix">
								<li class="template-layout-column-left">
									<div class="template-component-image template-component-image-hover-slide-enable template-fancybox template-preloader">
										<a href="media/image/_sample/525x560/2.jpg" data-fancybox-group="team-1">
								...
								<li class="template-layout-column-right">
									<h3 class="template-component-team-name">Rebeca Wilson</h3>
									<span class="template-component-team-position">Teacher</span>
									<p class="template-component-team-description">I have completed a Graduate Diploma in Early Childhood Teaching. I have worked with children aged from six weeks to eight years. This is my second year at Fable. In addition to working at the Kinder I also work as a consultant, providing information sessions and training for parents, educators and teachers.</p>
									<h6 class="template-margin-top-3">Personal Info</h6>
									<div class="template-component-vertical-grid">
										<ul>
											<li class="template-component-vertical-grid-line-1n">
						...
						<li class="template-layout-column-left">
							<ul class="template-layout-33x66 template-clear-fix">
								<li class="template-layout-column-left">
									<div class="template-component-image template-component-image-hover-slide-enable template-fancybox template-preloader">
										<a href="media/image/_sample/525x560/11.jpg" data-fancybox-group="team-1">
								...
								<li class="template-layout-column-right">
									<h3 class="template-component-team-name">Betty Spencer</h3>
									<span class="template-component-team-position">Teacher</span>
									<p class="template-component-team-description">My name is Betty. I grew up and studied in Canada. This is my second year at Fable and love every minute of it, making the children’s learning experience fun. I love giving children opportunities to make discoveries about their world by providing them with the time and space to explore.</p>
									<h6 class="template-margin-top-3">Personal Info</h6>
									<div class="template-component-vertical-grid">
										<ul>
											<li class="template-component-vertical-grid-line-1n">
