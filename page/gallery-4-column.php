		...
		<div class="template-header">
			...
			<div class="template-header-bottom">
				<?php Template::includeHeaderBottom('IV Columns Gallery','IV Columns Layout',8,1); ?>
			</div>
					...
					<ul class="template-layout-25x25x25x25 template-clear-fix">
						...
						<li class="template-layout-column-center-left">
							<div class="template-component-image template-component-image-hover-slide-enable template-fancybox template-preloader">
								...
								<p><b>Classes in Paintin</b> Shining Stars Class</p>
							</div>			
						</li>
						...
						<li class="template-layout-column-left">
							<div class="template-component-image template-component-image-hover-slide-enable template-fancybox template-preloader">
								<a href="media/image/_sample/1050x770/8.jpg" data-fancybox-group="gallery-1">
						...
						<li class="template-layout-column-center-left">
							<div class="template-component-image template-component-image-hover-slide-enable template-fancybox template-preloader">
								<a href="media/image/_sample/1050x770/9.jpg" data-fancybox-group="gallery-1">
