		...
		<div class="template-content">
				...
				<div class="template-main template-section-white">
					...
					<div class="template-component-feature template-component-feature-style-2 template-component-feature-position-left template-component-feature-size-medium">
						<ul class="template-layout-33x33x33 template-clear-fix">
							<li class="template-layout-column-left">
								<div class="template-icon-feature template-icon-feature-name-gallery-alt"></div>
								<h5>Quisque Morbi</h5>
							...
							<li class="template-layout-column-center">
								...
								<h5>Integer Ligula</h5>
								<p>Pulvinar est metro ligula blandit maecenas retrum gravida cuprum.</p>		
							</li>	
							<li class="template-layout-column-right">
								<div class="template-icon-feature template-icon-feature-name-fastfood-alt"></div>
								<h5>Nunc Blandit</h5>
								<p>Pulvinar est metro ligula blandit maecenas retrum gravida cuprum.</p>		
							</li>
							<li class="template-layout-column-left">
							...
							<li class="template-layout-column-center">
								<div class="template-icon-feature template-icon-feature-name-quote-alt"></div>
								<h5>Mauris Solutide</h5>
								<p>Pulvinar est metro ligula blandit maecenas retrum gravida cuprum.</p>		
							</li>	
							<li class="template-layout-column-right">
								<div class="template-icon-feature template-icon-feature-name-rattle-alt"></div>
			...
			<div class="template-content-section template-padding-bottom-5">
				...
				<div class="template-main">
					...
					<!-- Feature -->
					<div class="template-component-feature template-component-feature-style-3 template-component-feature-position-top template-component-feature-size-small">
						<ul class="template-layout-25x25x25x25 template-clear-fix">
							<li class="template-layout-column-left">
								<div class="template-icon-feature template-icon-feature-name-database"></div>
								<h5>Quisque Morbi</h5>
								<p>Proin id blandit dolor vel porta mauris nulla a dolor porttitor enim laoreet porttitor augue.</p>
							</li>
							<li class="template-layout-column-center-left">
								<div class="template-icon-feature template-icon-feature-name-cutlery"></div>
								<h5>Magento Care</h5>
								<p>Aenean quis tincidunt arcu in lacinia augue mauris a nisi at dictum mattis imperdiet.</p>
							</li>
							<li class="template-layout-column-center-right">
								<div class="template-icon-feature template-icon-feature-name-cot"></div>
								<h5>Mauris Solutide</h5>
								<p>Vestibulum sed est sagittis mi commodo laoreet cum sociis natoque penatibus et magnis.</p>
							</li>
							<li class="template-layout-column-right">
								<div class="template-icon-feature template-icon-feature-name-coffee"></div>
								<h5>Integer Ligula</h5>
								<p>Phasellus pretium odio quis porta hendrerit bivamus imperdiet sollicitudin orci.</p>
							</li>
							<li class="template-layout-column-left">
								<div class="template-icon-feature template-icon-feature-name-clock"></div>
								<h5>Nunc Blandit</h5>
								<p>Nam hendrerit nunc vel erat consectetur nec luctus lectus vulputate duis id sollicitudin.</p>
							</li>
							<li class="template-layout-column-center-right">
								<div class="template-icon-feature template-icon-feature-name-chat"></div>
								<h5>Phasellus Novum</h5>
								<p>Sed ullamcorper ligula sit amet tristique consequat fusce pretium diam sit amet augue.</p>
							</li>
							<li class="template-layout-column-center-left">
								<div class="template-icon-feature template-icon-feature-name-chart"></div>
								<h5>Quisque Morbi</h5>
								<p>Proin sit amet luctus tellus integer accumsan diam dolor non iaculis lorem suscipit non.</p>
							</li>
							<li class="template-layout-column-right">
								<div class="template-icon-feature template-icon-feature-name-calendar"></div>
								<h5>Magento Care</h5>
								<p>Lunc vestibulum mauris sit amet ipsum iaculis ut sollici dui laoreet suspendisse.</p>
							</li>
						</ul>
					</div>
