		...
		<div class="template-header">
			...
			<div class="template-header-bottom">
				<?php Template::includeHeaderBottom('Gallery Right Sidebar','Gallery Right Sidebar',8,1); ?>
			</div>
		...
		<div class="template-content">
			...
			<div class="template-content-section template-content-layout template-content-layout-sidebar-right template-main template-clear-fix ">
				...
				<div class="template-content-layout-column-left">
					...
					<h4>Gallery Right Sidebar</h4>

					<p class="template-padding-reset">
						Duis congue erat vel hendrerit mattis ligula ex aliquet lorem ut ultrices eros neque et semi donec eget tellus vulputate tempus dui eget tincidunt odio donec nibh magna.
					</p>
						...
						<ul class="template-layout-50x50 template-clear-fix">
							<li class="template-layout-column-left">
								<div class="template-component-image template-component-image-hover-slide-enable template-fancybox template-preloader">
									<a href="media/image/_sample/1050x770/3.jpg" data-fancybox-group="gallery-1">
							...
							<li class="template-layout-column-right">
								<div class="template-component-image template-component-image-hover-slide-enable template-fancybox template-preloader">
									<a href="media/image/_sample/1050x770/2.jpg" data-fancybox-group="gallery-1">
				...
				<div class="template-content-layout-column-right">
					<?php Template::includeFile('gallery-sidebar'); ?>
				</div>
